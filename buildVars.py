...
addon_info = {
	...
	"addon_version": "1.0",
	# Author(s)
	"addon_author": "Antonio Cascales <correo@dominio.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/antramcs/DLEChecker",
...
pythonSources = ["addon/*.py", "addon/globalPlugins/DLEChecker/*.py", "addon/globalPlugins/DLEChecker/bs4/*.py"]
